main() {
  ...
  if [ -f /root/.zshrc ] || [ -h /root/.zshrc ]; then
    printf "${YELLOW}Found /root/.zshrc.${NORMAL} ${GREEN}Backing up to /root/.zshrc.pre-oh-my-zsh${NORMAL}\n";
    mv /root/.zshrc /root/.zshrc.pre-oh-my-zsh;
  fi

  printf "${BLUE}Using the Oh My Zsh template file and adding it to /root/.zshrc${NORMAL}\n"
